...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
        <a href="{{ route('admin.pools.add')}}" type="button"   class="btn btn-sm btn-primary float-end mb-2" data-bs-toggle="tooltip" title="Add Catgory">
                <i class="fa fa-plus"></i> Add Pools
                </a>
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#FoamTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.pools.getdatatable') }}",
            columns: [
                { data: 'id'},
                { data: 'actions'},
                { data: 'pool_name'},

...
@section('page_title','infinity Rate/Sqm')
@section('pools_select','active')
@section('container')

<<div class="container-fluid">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">edit infinity rate</h5>
        <div class="card">
            <div class="card-body">
                <form id="productform" data-csrf-token="{{ csrf_token() }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="excavation2" id="excavation2" value="{{$excavation2 ?? ''}}"  >
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="leveling_compaction2" id="rate2"  value="{{$leveling_compaction2 ?? ''}}" >
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="compaction_test2" id="rate3" value="{{$compaction_test2 ?? ''}}"  >
                        </div>
                    </div>
                    
                    <div class="mb-3 row">
                        <div class="col-sm-3">
                            <label for="polyethylene_sheet_1000_gauge2" class="form-label">Polyethylene Sheet 1000 Gauge</label>
                        </div>
                        <div class="col-sm-2">
                            <label for="rate4" class="form-label">Rate/Sqm</label>
                            <input type="number" class="form-control" name="polyethylene_sheet_1000_gauge2" id="rate4" value="{{$polyethylene_sheet_1000_gauge2 ?? ''}}" >
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="rubble_soling_230_th2" id="rate5" value="{{$rubble_soling_230_th2 ?? ''}}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="msrc_pcc_150mm_thick2" id="rate6" value="{{$msrc_pcc_150mm_thick2 ?? ''}}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="modular_panels2" id="rate7" value="{{$modular_panels2 ?? ''}}" >
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="overflow_gutter2" id="rate8"  value="{{$overflow_gutter2 ?? ''}}" >
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="fiber_lining2" id="rate9" value="{{$fiber_lining2 ?? ''}}" >
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="paper_glass_tiling_1ft_x_1ft2" id="rate11" value="{{$paper_glass_tiling_1ft_x_1ft2 ?? ''}}" >
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="granite_coping2" id="rate11" value="{{$granite_coping2 ?? ''}}" >
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" class="form-control" name="clamps2" id="rate12" value="{{$clamps2 ?? ''}}" >
                        </div>
                    </div>
...
$(document).ready(function() {
    $('#productform').on('submit', function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ route('admin.infinity.manage_process') }}',
            data: formData,
            processData: false,
            contentType: false,
            headers: {
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    window.location.href = "{{ route('admin.infinity.list') }}";
                } else {
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
